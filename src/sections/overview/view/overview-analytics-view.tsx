...
export function OverviewAnalyticsView() {
  const { shopLinks, fetchShopLinks } = useShopLink();
      ...
      <Grid container spacing={3}>
        ...
        <Grid xs={12} md={6} lg={8}>
          <AnalyticsWebsiteVisits
            ...
            subheader='(+100%) than last year'
            chart={{
              categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug'],
              series: [
                { name: 'Extension', data: [0, 0, 0, 1, 2, 4, 4, 8] },
                { name: 'Mobile App', data: [0, 0, 0, 1, 1, 2, 5, 10] }
              ]
            }}
          />
        </Grid>
