...
// import useProductLink from 'src/hooks/student'
...
type ProductLinkTableToolbarProps = {
    numSelected: number
    filterName: string
    onFilterName: (event: React.ChangeEvent<HTMLInputElement>) => void
    // filters: FiltersProps
    // setFilters: (filters: FiltersProps) => void
    // dataFiltered: IProductLink[]
}
...
export function ProductLinkTableToolbar({
    numSelected,
    filterName,
    onFilterName,
    // filters,
    // setFilters,
    // dataFiltered
}: ProductLinkTableToolbarProps) {
    const { loading, error, success } = useProductLink()
