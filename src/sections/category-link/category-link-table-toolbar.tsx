...
// import useCategoryLink from 'src/hooks/student'
...
type CategoryLinkTableToolbarProps = {
    numSelected: number
    filterName: string
    onFilterName: (event: React.ChangeEvent<HTMLInputElement>) => void
    // filters: FiltersProps
    // setFilters: (filters: FiltersProps) => void
    // dataFiltered: ICategoryLink[]
}
...
export function CategoryLinkTableToolbar({
    numSelected,
    filterName,
    onFilterName,
    // filters,
    // setFilters,
    // dataFiltered
}: CategoryLinkTableToolbarProps) {
    const { loading, error, success } = useCategoryLink()
